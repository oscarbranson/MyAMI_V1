...
def func_Kb(ts, a, b, c, d, e, f, g, h, i, j, k, l):
    (TempK,Sal) = ts
...
def func_KspC(ts, a, b, c, d, e, f, g, h, i):
    (TempK,Sal) = ts
    sqrtSal = numpy.sqrt(Sal)
...
def func_KspA(ts, a, b, c, d, e, f, g, h, i):
    (TempK,Sal) = ts
    sqrtSal = numpy.sqrt(Sal)
    log10TempK = numpy.log10(TempK)
...
def func_KSO4(ts, a, b, c, d, e, f, g, h, i, j, k):
    (TempK,Sal) = ts
